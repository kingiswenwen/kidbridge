...
const sentences: Sen[] = [
  { emoji: '👋', en: 'Good morning!', cn: '早上好！', tags: ['问候', '早上'] },
  { emoji: '🌞', en: 'How are you today?', cn: '你今天好吗？', tags: ['问候', '日常'] },
  { emoji: '😊', en: "I'm fine, thank you.", cn: '我很好，谢谢你。', tags: ['问候', '回应'] },
  { emoji: '👋', en: 'Good night, sweet dreams.', cn: '晚安，好梦。', tags: ['问候', '睡前'] },
  { emoji: '👋', en: 'See you tomorrow!', cn: '明天见！', tags: ['告别'] },
  { emoji: '🧒', en: 'My name is Xiao Ming.', cn: '我叫小明。', tags: ['自我介绍', '名字'] },
  { emoji: '🎂', en: "I'm five years old.", cn: '我五岁啦。', tags: ['自我介绍', '年龄'] },
  { emoji: '🍚', en: "Let's have dinner.", cn: '我们一起吃晚饭吧。', tags: ['吃饭', '邀请'] },
  { emoji: '🍎', en: 'I like apples very much.', cn: '我非常喜欢苹果。', tags: ['喜好', '水果'] },
  { emoji: '💧', en: 'Can I have some water?', cn: '我可以喝点水吗？', tags: ['请求', '喝水'] },
  { emoji: '🚽', en: 'I want to go to the bathroom.', cn: '我想去洗手间。', tags: ['请求', '生活'] },
  { emoji: '❤️', en: 'I love you, Mom and Dad.', cn: '爸爸妈妈，我爱你们。', tags: ['家人', '表达'] },
  { emoji: '🏫', en: 'Let us go to school.', cn: '我们去上学吧。', tags: ['上学', '邀请'] },
  { emoji: '📚', en: 'I like reading books.', cn: '我喜欢看书。', tags: ['学习', '喜好'] },
  { emoji: '🎨', en: 'I can draw a cat.', cn: '我会画一只小猫。', tags: ['能力', '画画'] },
  { emoji: '🎵', en: 'Let us sing a song together.', cn: '我们一起唱首歌吧。', tags: ['唱歌', '邀请'] },
  { emoji: '🏃', en: 'Can you run fast?', cn: '你能跑得快吗？', tags: ['运动', '提问'] },
  { emoji: '🎮', en: 'May I play with you?', cn: '我可以和你一起玩吗？', tags: ['游戏', '请求'] },
  { emoji: '🙏', en: 'Thank you very much!', cn: '非常感谢你！', tags: ['礼貌', '感谢'] },
  { emoji: '🙂', en: "You're welcome.", cn: '不客气。', tags: ['礼貌', '回应'] },
  { emoji: '😢', en: "I'm sorry. I didn't mean it.", cn: '对不起，我不是故意的。', tags: ['礼貌', '道歉'] },
  { emoji: '💪', en: 'Never mind. Let us try again.', cn: '没关系，我们再试一次。', tags: ['鼓励', '回应'] },
  { emoji: '🫶', en: 'Can you help me?', cn: '你能帮帮我吗？', tags: ['请求', '帮助'] },
  { emoji: '👍', en: 'You did a great job!', cn: '你做得真棒！', tags: ['夸奖', '鼓励'] },
  { emoji: '⏰', en: "It's time to get up.", cn: '该起床啦。', tags: ['生活', '提醒'] },
];
